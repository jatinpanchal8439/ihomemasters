						...
						<div class="col-md-12 col-xl-6">
							<div class="about-one-rightbox">
								<div class="pbmit-heading-subheading animation-style2">
									...
									<h2 class="pbmit-title">Crafting Beautiful, Functional Spaces for Your Lifestyle</h2>
									<div class="pbmit-heading-desc">
										Creating stylish and practical spaces that perfectly match your needs and enhance your everyday living experience.
									</div>
								</div>
								<div class="row g-3">
									<div class="col-md-6">
