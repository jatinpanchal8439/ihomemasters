						...
						<div class="col-md-12 col-xl-6">
							<div class="accordion-two-rightbox">
								<div class="chair-img pbmit-move-sofa">
									<img src="images/homepage-2/bg/chair.webp" alt="">
								</div>
								<div class="sofa-img pbmit-move-sofa">
									<img src="images/homepage-2/bg/sofa.webp" class="img-fluid" alt="">
								</div>
								<div class="floor-img">
									<img src="images/homepage-2/bg/floor.webp" class="img-fluid" alt="">
								</div>
							</div>
						</div>
					</div>
