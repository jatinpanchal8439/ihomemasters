...
<head>
  ...
  <title>IHOMEMASTERS | Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../img/logo/fav-icon.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">IHOMEMASTERS</a>
        </div>
      </div>
...
<!-- Contact Us -->
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item <?php if($url=="/ecommerce_website/admin/contact.php") { echo "menu-open"; } ?>">
            <a href="#" class="nav-link <?php if($url=="/ecommerce_website/admin/contact.php") { echo "active"; } ?>">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="contact.php" class="nav-link <?php if($url=="/ecommerce_website/admin/contact.php") { echo "active"; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Contact Us Form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="calculator.php" class="nav-link <?php if($url=="/ecommerce_website/admin/calculator.php") { echo "active"; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Calculator Form</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="kcalculator.php" class="nav-link <?php if($url=="/ecommerce_website/admin/kcalculator.php") { echo "active"; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View K-Calculator Data</p>
                </a>
              </li>
            </ul>
          </li>
